    ...
    <div class="main-content">
        ...
        <div class="search-row">
            ...
            <select id="filterCategory" class="form-select form-select-sm ms-2" style="width: 150px;">
                ...
                <?php
                    ...
                    $categories = []; // mảng lưu category đã xuất hiện
        ...
        <div class="product-list" id="productList">
            <?php
                ...
                foreach ($products as $prod):
                    $image = !empty($prod["imge"]) 
                        ? $prod["imge"] 
                        : "../../../public/img/default_product.png";
            ?>
            ...
            <div class="product-item"
                ...
                <div class="product-actions">
                    <button class="action-btn btn-view"
                        ...
                        data-description="<?= htmlspecialchars($prod["description"]) ?>"
                        data-click="<?= htmlspecialchars($prod["click"]) ?>"
                        data-create="<?= htmlspecialchars($prod["created_at"]) ?>"
                        data-image="<?= $image ?>">
                        Xem
                    </button>
    ...
    <div id="editProductModal" class="modal">
        <div class="modal-content">
            ...
            <form id="editProductForm" enctype="multipart/form-data">
                ...
                <input type="file" id="editImage" name="imge" class="form-control">

...
<head>
    ...
    <meta name="description" content="Read the latest article: <?= htmlspecialchars($article['title'] ?? 'Article'); ?>">
    <meta name="keywords" content="news, article, blog">
    <title><?= htmlspecialchars($article['title'] ?? 'Article'); ?> - Your Site Name</title>
